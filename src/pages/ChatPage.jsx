    ...
    <section className="mx-auto max-w-7xl space-y-6 px-4 py-6 sm:px-6 text-[#4a4a6a]">
      <header className="relative overflow-hidden rounded-[2.5rem] bg-[#e0e5ec] p-6 shadow-neu sm:p-8">
        ...
        <div className="relative z-10 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h1 className="text-4xl font-black tracking-tight text-[#4a4a6a]">Messages 💬</h1>
            <p className="mt-2 text-sm font-medium text-slate-500">Stay connected with your friends.</p>
          </div>
          {activeFriend && (
